...
# AUTHOR: David Malone
# FILENAME: cnn.py
# SPECIFICATION: Convolutional Neural Network that classifies handwritten digits
...
X_train = X_train.reshape(num_images_train, 32, 32, 1)
X_test = X_test.reshape(num_images_test, 32, 32, 1)
